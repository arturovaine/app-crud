...
export class Insurer extends BaseModel implements IInsurer  {
    static TYPE_SELECTOR = 'Insurer';
    ...
    */
    constructor(values?: Partial<IInsurer>) {
        super();

        this.typeSelector = Insurer.TYPE_SELECTOR;
    ...
    */
    setValues(values: Partial<IInsurer>): void {
        if (values) {
            
            const rawValues = values
            this.contractReference = this.getValue<string>(rawValues, Insurer.CONTRACT_REFERENCE_FIELD_NAME);
            ...
            this.typeSelector = this.getValue<string>(rawValues, Insurer.TYPE_SELECTOR_FIELD_NAME);
        }
    }
}

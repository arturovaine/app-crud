...
export interface IPartyRoleInContract {
...
export class PartyRoleInContract extends BaseModel implements IPartyRoleInContract  {
    static TYPE_SELECTOR = 'PartyRoleInContract';
    ...
    */
    constructor(values?: Partial<IPartyRoleInContract>) {
        super();

        this.typeSelector = PartyRoleInContract.TYPE_SELECTOR;
    ...
    */
    setValues(values: Partial<IPartyRoleInContract>): void {
        if (values) {
            
            const rawValues = values
            this.contractReference = this.getValue<string>(rawValues, PartyRoleInContract.CONTRACT_REFERENCE_FIELD_NAME);
            ...
            this.typeSelector = this.getValue<string>(rawValues, PartyRoleInContract.TYPE_SELECTOR_FIELD_NAME);
        }
    }
}
